...
/* ── v0.2.0 generic multimodal capability IR (ADDITIVE) ──────────────────────
 * Business-NEUTRAL: NO tier, NO productId, NO "vision is always Gemini" rule.
 * Whichever adapter supports image INPUT implements VisionModel; whichever
 * supports image GENERATION implements ImageModel. Storage (R2) stays in the
 * consumer — ImageResult returns raw base64 bytes + meta, NO assetKey.
 */
